...
//     const finalKey = match ? columnMap[match] : cleanKey;

//     if (!allowedColumns.has(finalKey)) return;
...
//       DT_INICIAL: excelDate(n.DT_INICIAL),
//       DT_ROMANEIO: excelDate(n.DT_ROMANEIO),
//       DT_ENTRADA: excelDate(n.DT_ENTRADA),
//       DT_SAIDA: excelDate(n.DT_SAIDA),

//       HR_INICIAL: excelTime(n.HR_INICIAL),
//       HR_ROMANEIO: excelTime(n.HR_ROMANEIO),
//       HR_ENTRADA: excelTime(n.HR_ENTRADA),
//       HR_SAIDA: excelTime(n.HR_SAIDA),

//       PLACA_CAVALO: formatPlaca(n.PLACA_CAVALO),
//       PLACA_CARRETA: formatPlaca(n.PLACA_CARRETA),
//     };

//     record.DEDUPE_KEY = createDedupeKey(record);
